...
public class 第K大数 {
    public int findKth(int[] a, int n, int K) {
        ...
        while (true) {
            int target = a[begin], b = begin, e = end;
            while (begin < end) {
